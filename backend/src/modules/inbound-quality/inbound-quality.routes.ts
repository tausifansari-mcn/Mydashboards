...
router.get('/clap-keyword-drill',     ctrl.getClapKeywordDrill);
router.get('/clap-words',             ctrl.getClapWords);
router.get('/transcript',             ctrl.getTranscript);
router.get('/raw-data-tab',           requireDashboardAccess('raw-data'), ctrl.getRawCallData);
...
router.get('/agent-guidance',           ctrl.getAgentGuidance);
...
router.get('/tni-analysis',            ctrl.getTNIAnalysis);
