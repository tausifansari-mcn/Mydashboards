...
export default function GncUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      fd.append('file', file);
      const res = await api.post('/sales/upload-gnc', fd, {
        onUploadProgress: (e) => {
  ...
  return (
    <div>
      <div
        ...
        onClick={() => document.getElementById('gnc-file-input')?.click()}
      ...
      >
        ...
        <p className="text-sm font-semibold text-slate-700 mb-1">Drop your GNC file here or click to browse</p>
        ...
        <div className="mt-4 flex items-start gap-3 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-emerald-600 text-xs mt-0.5">
              {result.rowsInserted} of {result.totalRows} rows inserted
            </p>
          </div>
