...
export default function BellavitaChatUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      fd.append('file', file);
      const res = await api.post('/sales/upload-bellavita-chat', fd, {
        onUploadProgress: (e) => {
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-sm font-semibold text-slate-800">Bellavita Chat Upload</h2>
      </div>

      <div
        onDrop={handleDrop}
        onDragOver={e => e.preventDefault()}
        onClick={() => document.getElementById('bv-chat-input')?.click()}
      ...
      >
        ...
        <p className="text-sm font-semibold text-slate-700 mb-1">Drop chat file here or click to browse</p>
