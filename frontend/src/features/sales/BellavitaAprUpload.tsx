...
export default function BellavitaAprUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      fd.append('file', file);
      const res = await api.post('/sales/upload-bellavita-apr', fd, {
        onUploadProgress: (e) => {
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-sm font-semibold text-slate-800">Bellavita APR Upload</h2>
      </div>

      <div
        onDrop={handleDrop}
        onDragOver={e => e.preventDefault()}
        onClick={() => document.getElementById('bv-apr-input')?.click()}
      ...
      >
        ...
        <p className="text-sm font-semibold text-slate-700 mb-1">Drop APR file here or click to browse</p>
