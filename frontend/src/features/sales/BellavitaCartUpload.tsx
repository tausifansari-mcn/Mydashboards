...
export default function BellavitaCartUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      fd.append('file', file);
      const res = await api.post('/sales/upload-bellavita-cart', fd, {
        onUploadProgress: (e) => {
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-sm font-semibold text-slate-800">Bellavita Cart Upload</h2>
      </div>

      <div
        onDrop={handleDrop}
        onDragOver={e => e.preventDefault()}
        onClick={() => document.getElementById('bv-cart-input')?.click()}
      ...
      >
        ...
        <p className="text-sm font-semibold text-slate-700 mb-1">Drop Cart file here or click to browse</p>
