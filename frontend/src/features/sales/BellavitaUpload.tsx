...
export default function BellavitaUpload() {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      fd.append('file', file);
      const res = await api.post('/sales/upload-bellavita', fd, {
        onUploadProgress: (e) => {
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-sm font-semibold text-slate-800">Bellavita Sale Upload</h2>
      </div>
      ...
      <div
        ...
        onClick={() => document.getElementById('bv-file-input')?.click()}
