            ...
            <div className="w-64 shrink-0 border-l border-slate-200 bg-slate-50 overflow-auto p-4 flex flex-col gap-4">
              ...
              <div>
                ...
                <div className="space-y-1 text-[11px] text-slate-600">
                  <p><span className="font-semibold">Customer Number:</span> {fatalItem.mobile_no || '—'}</p>
            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="sticky top-0">
                  ...
                  <th className="px-3 py-2.5 text-left">Customer Number</th>
              ...
              <tbody>
                {calls.map((c, i) => (
                  <tr key={c.lead_id + i} className="border-t border-slate-100 hover:bg-red-50 transition-colors">
                    ...
                    <td className="px-3 py-2 text-slate-600 font-mono whitespace-nowrap">{c.mobile_no || '—'}</td>
